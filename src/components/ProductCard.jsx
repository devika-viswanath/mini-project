...
const ProductCard = ({ product }) => {
    ...
    return product && (
        <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
            <div className="group cursor-pointer flex items-center justify-center px-2" onClick={handleProductClick}>
                <img 
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <p className="text-gray-700 font-medium text-lg truncate w-full cursor-pointer hover:text-indigo-500" onClick={handleProductClick}>{product.name}</p>
